...
from .config.models import WorkflowStep
...
def mono_agent(
    ...
    try:
        ...
        set_original_user_prompt(user_input)
    ...
    try:
        ...
        while True:
            try:
                ...
                if steps_enabled[WorkflowStep.PLAN]:
                    console.print("\n[green]📄 Planner[/green]")
                    ...
                    try:
                        ...
                        if complete_plan == "":
                            print(
                                "[red]No plan was generated by the planner swarm.[/red] Falling back to user input."
                            )
                            complete_plan = user_input

                    except Exception as e:
                        console.print(f"[bold red]Planner error: {str(e)}[/bold red]")
                        console.print(
                            "[bold yellow]Skipping planner step...[/bold yellow]"
                        )

                if steps_enabled[WorkflowStep.CODE]:
                    console.print("\n[green]📋 Todo + 📚 Composer[/green]")
                    ...
                    try:
                        ...
                        console.print(f"[bold red]Todo error: {str(e)}[/bold red]")
                        console.print(
                            "[bold yellow]Skipping todo step...[/bold yellow]"
                        )
                    ...
                    try:
                        ...
                        console.print(f"[bold red]Composer error: {str(e)}[/bold red]")
                        console.print(
                            "[bold yellow]Skipping composer step...[/bold yellow]"
                        )

                if steps_enabled[WorkflowStep.REVIEW]:
                    console.print("\n[green]🔍 Review[/green]")
                    ...
                    try:
                        ...
                        console.print(f"[bold red]Review error: {str(e)}[/bold red]")
                        console.print(
                            "[bold yellow]Skipping review step...[/bold yellow]"
                        )
